...
const suppressedMessages = [
  ...
  'OVERMIND: You are running in DEVELOPMENT mode',
  'undefined used as a key, but it is not a string.',
  'Warning: Each child in a list should have a unique',
  'Warning: In Concurrent or Sync modes,',
  'Warning: unmountComponentAtNode()',
  'Warning: You are calling ReactDOM.unmountComponentAtNode',
      ...
      switch (type) {
        ...
        case 'console':
          ...
          switch (method) {
            ...
            default:
              const includesSuppressedMessage =
                typeof args[0] === 'string' &&
                suppressedMessages.some(message => args[0].match(message))
