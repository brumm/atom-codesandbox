...
export default {
    ...
    this.subscriptions = new CompositeDisposable(
      ...
      atom.commands.add('atom-workspace', {
        ...
        'codesandbox:new-scratch-pad': () => {
          this.panel = atom.workspace.addModalPanel({ item: this.selectListView.element })
  ...
  updateTemplateSelectList() {
    const templates = JSON.parse(fs.readFileSync(configPath, 'utf8')).scratchpadTemplates.reduce(
